...
if ( $attachment_ids ) {
	$loop 		= 0;
	?>
	<div id="image-thumbnail" class="image-thumbnail slick-carousel"  data-columns4="<?php echo esc_attr($columns); ?>" data-columns3="<?php echo esc_attr($columns); ?>" data-columns2="<?php echo esc_attr($columns); ?>" data-columns1="<?php echo esc_attr($columns); ?>" data-columns="<?php echo esc_attr($columns); ?>" data-nav="true" <?php echo esc_attr(phami_image_single_product()->class_data_image); ?>>
	<?php
