...
<form class="cart" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="group_table">
		<tbody>
			<tr>
				<th><span><?php echo esc_html__("Image","phami"); ?></span></th>
				<th><span><?php echo esc_html__("Product Name","phami"); ?></span></th>
				<th><span><?php echo esc_html__("Price","phami"); ?></span></th>
				<th><span><?php echo esc_html__("Qty","phami"); ?></span></th>
			</tr>		
			<?php
					...
					<tr id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
						<td class="product-thumb">
							<a href="<?php echo esc_url( apply_filters( 'woocommerce_grouped_product_list_link', get_permalink( $grouped_product->get_id() ), $grouped_product->get_id() ) ); ?>" >
								...
								<?php }else{ ?>
									<img src="<?php echo get_template_directory_uri(); ?>/images/placeholder.jpg" alt="<?php echo esc_attr__('No thumb', 'phami'); ?>">
								<?php } ?>
							</a>
						</td>
						<td>
