...
<?php
		 ...
		 * @hooked phami_woocommerce_breadcrumb - 20
		 */
...
<div class="container clearfix">
	<div class="contents-detail">
		<div class="main-single-product row">
			...
			<?php endif; ?>			
			<div class="<?php echo esc_attr(phami_get_class()->class_detail_product_content); ?> <?php if(is_active_sidebar('sidebar-product') && $sidebar_detail_product == 'left'){ echo "pull-right"; } ?>">
