<?php 
	...
	$class = 'masonry-post '.esc_attr(phami_get_class()->class_item_blog);
?>
	...
	<div class="entry-post">
		...
		<div class="post-content">
			...
			<div class="entry-infor">
				<?php phami_posted_on_2(); ?>
			</div>
			<?php
        		if (phami_get_config('blog-excerpt')) {
                    echo phami_get_excerpt( phami_get_config('grid-blog-excerpt-length',15), true);
                }
			?>
		</div>
	</div>
