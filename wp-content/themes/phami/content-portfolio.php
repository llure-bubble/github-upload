<?php $phami_settings = phami_global_settings(); ?>
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 content-right">
			...
			<div class="portfolio-content">
				<?php 
					$show_post_title = phami_get_config('portfolio-title',true);
					if ($show_post_title){
						if ( is_single() ){
				...
				<?php
					the_content();
					wp_link_pages( array(
						'before'      => '<div class="page-links clearfix"><span class="page-links-title">' . esc_html__( 'Pages:', 'phami' ) . '</span>',
						'after'       => '</div>',
						'link_before' => '<span>',
						'link_after'  => '</span>',
					) );
				...
				<div class="portfolio-infomation">
					...
					<div class="post-date">
						<strong><?php echo esc_html__("Date","phami") ?></strong>
						<span class="entry-date"><?php echo phami_time_link(); ?></span>
					</div>
					<?php if($portfolio){ ?>
					<div class="categories">
						<strong><?php echo esc_html__("Categories","phami") ?></strong>
					...
					<?php } ?>
					<?php if(phami_get_config('show_share')) : ?>
					<div class="entry-single">
						<?php if ( shortcode_exists( 'social_share' ) ) : ?> 
						<div class="entry-social-share">
							<strong><?php echo esc_html__("share",'phami') ?></strong>
