...
if( $category && !is_array( $category ) ){
	...
	if($attribute_taxonomies){
		...
		$atributes = '';
?>
<div class="bwp-filter-homepage <?php echo esc_attr($class); ?>" data-class_col = "<?php echo esc_attr($class_col); ?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>"  data-showmore="<?php echo esc_attr($columns); ?>" data-atributes="<?php echo esc_attr($atributes); ?>">
